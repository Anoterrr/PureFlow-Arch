...
def get_s3_paths(base_date=BASE_DATE):
    ...
    return {
        ...
        "vendas_quarantine": f"s3://{S3_BUCKET_QUARANTINE}/erp_vendas/dt={base_date}/vendas.parquet",
        "clientes_quarantine": f"s3://{S3_BUCKET_QUARANTINE}/crm_clientes/dt={base_date}/clientes.parquet",
    }
